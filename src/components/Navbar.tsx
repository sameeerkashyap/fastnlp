      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex h-14 items-center justify-between">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "bg-[var(--ember-light)] text-[var(--ember)] font-medium"
                      : "text-[var(--ink-2)] hover:text-[var(--ink)] hover:bg-cream-200"
                  )}
                >
                  {link.label}
                </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/curriculum"
              className="px-4 py-1.5 text-sm font-medium bg-[var(--ember)] text-white rounded-md hover:bg-ember-600 transition-colors no-underline"
            >
              Start learning →
            </Link>
          </div>
